...
class KaonParametersPhiRatioSimple(ModelParameters):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            a_phi_charged, a_phi_neutral, mass_phi, decay_rate_phi, a_phi_prime, mass_phi_prime, decay_rate_phi_prime,
    ...
    def _setup_data(self,
        ...
        return [
            ...
            Parameter(name='decay_rate_omega_double_prime', value=decay_rate_omega_double_prime, is_fixed=True),
            Parameter(name='a_phi_charged', value=a_phi_charged, is_fixed=False),
            Parameter(name='a_phi_neutral', value=a_phi_neutral, is_fixed=False),
            ...
            Parameter(name='mass_rho_prime', value=mass_rho_prime, is_fixed=True),
            Parameter(name='decay_rate_rho_prime', value=decay_rate_rho_prime, is_fixed=True),
            Parameter(name='mass_rho_double_prime', value=mass_rho_double_prime, is_fixed=True),
            Parameter(name='decay_rate_rho_double_prime', value=decay_rate_rho_double_prime, is_fixed=True),
        ]

    @classmethod
    def from_list(cls, list_of_parameters: List[Parameter]) -> 'KaonParametersPhiRatioSimple':
    ...
    def get_model_parameters_bounds_handpicked(self) -> Dict:
        ...
        return {
            ...
            'a_phi_charged': {'lower': -np.inf, 'upper': np.inf},
            'a_phi_neutral': {'lower': -np.inf, 'upper': np.inf},
    ...
    def from_ordered_values(
            ...
            t_0_isoscalar: float,
            t_0_isovector: float) -> 'KaonParametersPhiRatioSimple':
        names = [
            't_in_isoscalar',
            't_in_isovector',
            'mass_rho_prime',
    ...
    def fix_resonances(self):
        self.fix_parameters(['mass_rho', 'mass_rho_prime', 'mass_rho_double_prime',
                             ...
                             'mass_phi_double_prime', 'decay_rate_omega', 'decay_rate_phi',
                             'decay_rate_omega_double_prime', 'decay_rate_phi_prime','decay_rate_phi_double_prime',
                             ])
