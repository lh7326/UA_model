...
class NucleonParameters(ModelParameters):
    ...
    def get_ordered_values(self) -> List[float]:
        names = [
            't_in_dirac_isoscalar',
            't_in_dirac_isovector',
            't_in_pauli_isoscalar',
            't_in_pauli_isovector',
            'a_dirac_omega',
            'a_dirac_phi',
            'a_dirac_omega_prime',
            'a_dirac_phi_prime',
    ...
    def from_ordered_values(
        ...
        pars.extend([
            Parameter('nucleon_mass', nucleon_mass, True),
            Parameter('magnetic_moment_proton', magnetic_moment_proton, True),
            Parameter('magnetic_moment_neutron', magnetic_moment_neutron, True),
            Parameter('t_0_dirac_isoscalar', t_0_dirac_isoscalar, True),
            Parameter('t_0_dirac_isovector', t_0_dirac_isovector, True),
            Parameter('t_0_pauli_isoscalar', t_0_pauli_isoscalar, True),
            Parameter('t_0_pauli_isovector', t_0_pauli_isovector, True),
        ])
