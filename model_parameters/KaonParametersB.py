...
class KaonParametersB(ModelParameters):
    ...
    @classmethod
    def from_list(cls, list_of_parameters: List[Parameter]) -> 'KaonParametersB':
    ...
    def get_model_parameters_bounds_handpicked(self) -> Dict:
        ...
        return {
            ...
            'mass_omega': {'lower': 0.780, 'upper': 0.785},
            'decay_rate_omega': {'lower': 0.0086, 'upper': 0.0088},
    ...
    def from_ordered_values(
            ...
            t_0_isoscalar: float,
            t_0_isovector: float) -> 'KaonParametersB':
        names = [
            't_in_isoscalar',
            't_in_isovector',
            'mass_rho',
    ...
    def fix_resonances(self):
        self.fix_parameters(['mass_rho', 'mass_rho_prime', 'mass_rho_double_prime',
                             ...
                             'mass_phi', 'mass_omega', 'mass_omega_double_prime',
                             'mass_phi_prime', 'mass_phi_double_prime', 'decay_rate_phi',
                             'decay_rate_omega', 'decay_rate_omega_double_prime',
