...
class KaonParametersFixedSelected(ModelParameters):
    ...
    def _setup_data(self,
        ...
        return [
            ...
            Parameter(name='mass_omega_prime', value=mass_omega_prime, is_fixed=True),
    ...
    @classmethod
    def from_list(cls, list_of_parameters: List[Parameter]) -> 'KaonParametersFixedSelected':
    ...
    def get_model_parameters_bounds_handpicked(self) -> Dict:
        ...
        return {
            ...
            'decay_rate_omega_prime': {'lower': 0.2, 'upper': 0.4},
    ...
    def from_ordered_values(
            ...
            t_0_isoscalar: float,
            t_0_isovector: float) -> 'KaonParametersFixedSelected':
        names = [
            't_in_isoscalar',
            't_in_isovector',
            'mass_rho',
