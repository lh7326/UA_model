...
class KaonParametersFixedRhoOmega(ModelParameters):
    ...
    @classmethod
    def from_list(cls, list_of_parameters: List[Parameter]) -> 'KaonParametersFixedRhoOmega':
    ...
    def from_ordered_values(
            ...
            t_0_isoscalar: float,
            t_0_isovector: float) -> 'KaonParametersFixedRhoOmega':
        names = [
            't_in_isoscalar',
            't_in_isovector',
            'mass_rho',
