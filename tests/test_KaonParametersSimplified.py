...
class TestModelParametersSimplified(TestCase):
    ...
    def test___setitem__(self):
        with self.subTest(msg='Testing type checking'):
            with self.assertRaises(TypeError):
                self.parameters['a_phi'] = 2.0  # type: ignore
    ...
    def test_get_free_values(self):
        ...
        self.assertListEqual(
            ...
            [0.7, 0.8, 0.13, 1.465, 0.4, 0.14, 1.720, 0.25, 2.15, 0.3],
        )

    def test_get_all_values(self):
        self.assertListEqual(
            self.parameters.get_all_values(),
            [0.5, 0.6, 0.7, 0.8, 0.2, 1.410, 0.29,
    ...
    def test_from_list_to_list_consistency(self):
        list_of_parameters = [
            ...
            Parameter(name='mass_omega_prime', value=1.262175646031432, is_fixed=True),
            ...
            Parameter(name='a_rho_double_prime', value=-0.004875792606689498, is_fixed=True),
