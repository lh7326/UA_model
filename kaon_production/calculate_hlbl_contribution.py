...
def calculate_pi_n(form_factor_function, q1squared, q2squared, q3squared, n, particle_mass):
    if n in {1, 4, 7, 17, 39, 54}:
        ...
        return _calculate_pi_n(form_factor_function, q1squared, q3squared, q2squared, 2, particle_mass)
    elif n == 5:
...
def _calculate_a_hlbl_contribution(form_factor_function, alpha, particle_mass, muon_mass):
    ...
    return (alpha**3 / (432 * (math.pi**2)) ) * tplquad(
        integrand, a=0, b=numpy.inf, gfun=0, hfun=1, qfun=0, rfun=2*math.pi)
